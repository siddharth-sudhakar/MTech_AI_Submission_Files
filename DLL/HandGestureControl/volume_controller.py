"""Module 4 — Volume Controller: issues OS-level volume commands.

Primary:  pycaw (Windows Core Audio) — tries all three endpoint roles.
Fallback: ctypes keybd_event media keys, used when pycaw finds no device.
"""
