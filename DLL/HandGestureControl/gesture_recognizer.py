"""Module 3 — Gesture Recognizer: classifies hand landmarks into named gestures.
...
class GestureRecognizer:
    # Fingers must come within this fraction of hand span to activate pinch mode.
    PINCH_RATIO = 0.18
    ...
    def _finger_up(self, lm, tip, pip):
        return lm[tip][1] < lm[pip][1]  # tip above PIP joint → extended
