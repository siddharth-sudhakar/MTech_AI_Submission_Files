...
Gesture        Action
-----------    -----------------------------------------------
PINCH          close fingers to grab slider, spread to raise
               volume, close to lower; open wide to release
FIST           hold 0.5 s  →  toggle mute
OPEN PALM      hold 0.5 s  →  volume 100 %
PEACE SIGN     hold 0.5 s  →  volume 50 %
POINTING       hold 0.5 s  →  volume 25 %
Q              quit
"""
...
# Smoothing — prevents hand tremor from jittering the volume
PINCH_SMOOTH   = 0.15   # EMA factor: lower = smoother but more lag (try 0.1–0.3)
PINCH_DEADBAND = 0.012  # ignore ratio changes smaller than this
PINCH_SETTLE   = 1.5    # seconds of stillness to auto-release and lock volume
